...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        for csv in csvs:
                c = CopyMapping(AmpouleAudit,csv, dict(RecordID='RecordID', TimeStamp='TimeStamp', DeltaToUTC='DeltaToUTC', UserID='UserID', ObjectID='ObjectID', Description='Description', Comment='Comment', Checksum='Checksum'))
